...
from .models import Case, Request, EventType, Season
from .case_base import CaseBase
from .similarity import SimilarityCalculator, SimilarityWeights
...
class CaseRetriever:
    ...
    def _case_to_case_similarity(self, case1: Case, case2: Case) -> float:
        ...
        from .similarity import calculate_menu_similarity
